...
public class AdjustableClock extends Clock
{
    ...
    /**
     * @param MillisecondAdd Milliseconds to be added to the result of currentTimeMillis
     *                       A positive number means it will run faster, negative number means it will slower.
     */
